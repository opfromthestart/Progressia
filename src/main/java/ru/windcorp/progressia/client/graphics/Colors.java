...
public class Colors {
	...
	public static final Vec4 WHITE = toVector(0xFFFFFFFF), BLACK = toVector(0xFF000000),
			...
			LIGHT_GRAY = toVector(0xFFCBCBD0), BLUE = toVector(0xFF37A2E6), HOVER_BLUE = toVector(0xFFC3E4F7),
			DISABLED_GRAY = toVector(0xFFE5E5E5), DISABLED_BLUE = toVector(0xFFB2D8ED);
